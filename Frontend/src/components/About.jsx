...
const About = () => {
  const teamMembers = [
    {
      name: "Jayant Kishore",
      role: "MLOps Engineer",
      description: "Optimizes ML model, enabling seamless collaboration between data science and engineering",
      delay: 0.1,
    ...
    },
    {
      ...
      description: "Builds robust, secure backends with AI integration for real-time intelligence and seamless connectivity",
      delay: 0.2,
      linkedin: "https://www.linkedin.com/in/sindhu-kumari-48b413229?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    ...
    },
    {
      ...
      description: "Bridges frontend finesse and backend logic with full-stack expertise for seamless, end-to-end integration",
      delay: 0.3,
      linkedin: "https://linkedin.com",
      github: "https://github.com",
      imageUrl: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=150&q=80"
    },
    {
      name: "Pragya Kumari",
      role: "Frontend Developer",
      description: "Designs interactive interfaces and sleek dashboards that transform data into engaging, user-friendly experiences",
      delay: 0.4,
    ...
    },
    {
      ...
      role: "UX/UI Designer",
      description: "Crafts intuitive, accessible interfaces by blending design thinking with technical precision for seamless user experiences",
      delay: 0.5,
  ...
  return (
    <motion.div
      ...
      style={{
        background: 'linear-gradient(to right bottom, #0c0c0f, #181820, #212231, #2b2c43, #363755, #3a3553, #3d3451, #40324e, #362538, #281b25, #191015, #000000)'
      }}
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-purple-300 mb-4"
            style={{
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Advanced image analysis powered by neural networks
          </p>
        </motion.div>

        {/* Company Description */}
        <motion.div 
          className="p-8 rounded-xl border border-gray-800/50 shadow-lg shadow-gray-900/10 mb-16"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <p className="text-gray-300 text-lg mb-6 leading-relaxed">
            NeuroSpec leverages deep learning to provide industrial-grade visual inspection with 
            99.3% accuracy. Our brown-spectrum imaging technology detects defects invisible to 
            conventional systems.
          </p>
          <p className="text-gray-400/90 leading-relaxed">
            Founded in 2022, we combine neural networks with proprietary optics for unmatched 
            ...
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                style={{
                  ...
                  minHeight: '420px',
                  background: 'linear-gradient(to bottom right, rgba(25, 25, 30, 0.1) 0%, rgba(0, 0, 0, 0.7) 100%)'
                }}
              >
                <div className="flex-grow flex flex-col items-center">
                  {member.imageUrl ? (
                    <motion.img 
                      ...
                      onError={(e) => { 
                        e.target.src = `https://placehold.co/150x150/2b2c43/f3f4f6?text=${member.name.charAt(0)}`; 
                    ...
                    <motion.div 
                      ...
                      style={{
                        background: 'linear-gradient(145deg, #2b2c43 0%, #363755 100%)',
                        color: '#f3f4f6',
